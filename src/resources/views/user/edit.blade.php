...
@section('content')
<form id="form" role="form" method="POST" action="{{ route('admin.users.update', $user->id) }}">
	@csrf
	@method('PUT')
					...
					<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
						<div class="form-group row">
							...
							<div class="col-md-9 col-lg-10">
								<input type="text" id="name" name="name" class="form-control" placeholder="Nombre" value="{{ old('name', $user->name) }}">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-md-3 col-lg-2 col-form-label" for="email">Email</label>
							<div class="col-md-9 col-lg-10">
								<input type="email" id="email" name="email" class="form-control" placeholder="Email" value="{{ old('email', $user->email) }}">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-md-3 col-lg-2 col-form-label" for="email">Grupo de usuario</label>
							<div class="col-md-9 col-lg-10">
